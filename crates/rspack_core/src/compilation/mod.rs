...
pub struct Compilation {
  ...
  pub process_runtime_requirements_cache_artifact: StealCell<ProcessRuntimeRequirementsCacheArtifact>,
...
impl Compilation {
  ...
  pub fn new(
    ...
    Self {
      ...
      chunk_render_cache_artifact: StealCell::new(ChunkRenderCacheArtifact::new(MemoryGCStorage::new(
        match &options.cache {
      ...
      process_runtime_requirements_cache_artifact: StealCell::new(ProcessRuntimeRequirementsCacheArtifact::new(
        &options,
      )),
